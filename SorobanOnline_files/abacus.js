...
if (typeof Audio !== undefined) {
    bump = new Audio("/assets/bump.wav");
    move = new Audio("/assets/move.wav");
    drip = new Audio("/assets/drip.wav");
}
...
function initAbacus(canvasElement, spanElement, railsElement) {
    ...
    if (!canvasElement) {
        ...
        canvasElement.setAttribute("style", "margin-top:0px; margin-left: 8px; display:block;overflow:visible;z-index:2;");
...
function initLeeAbacus(canvas0Element, canvas1Element, canvasElement,
    ...
    for (var i = 0; i < number; i++) {
        ...
        abaci[i].abacusCanvasElement.style.backgroundColor = abaci[i].background;
        abaci[i].drawingContext = abaci[i].abacusCanvasElement.getContext("2d");
